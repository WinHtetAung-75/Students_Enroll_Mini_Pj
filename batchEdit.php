...
" method="post" class=" mt-5">
    <div class="mb-6 ">
        ...
        <input required type="text" id="name" name="name" value="<?= $batch['name'] ?>" class="bg-gray-50 border w-full lg:w-80 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    </div>
    ...
    <div class="mb-6 ">
        ...
        <select id="course_id" name="course_id" class="bg-gray-50 lg:w-80 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            ?>
                <option <?= $batch['course_id'] == $courses['id'] ? 'selected' : '' ?> value="<?= $courses['id'] ?>"><?= $courses['title'] ?></option>
            <?php endwhile ?>
        </select>
    </div>
    ...
    <div class="mb-6 ">
        ...
        <input required type="number" name="student_limit" value="<?= $batch['student_limit'] ?>" id="default-input" class="bg-gray-50 border lg:w-80 w-full  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    </div>

    <div class="mb-6 ">
        <label for="start_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start Date</label>
        <input required type="date" id="start_date" name="start_date" value="<?= $batch['start_date'] ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full lg:w-80 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </input>
    </div>
    ...
    <div class="flex gap-3 w-full lg:w-80 ">
        <div class=" w-full">
            ...
            <input id="start_time" required type="time" name="start_time" value="<?= $batch['start_time'] ?>" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Start Time">
        </div>

        <div class=" w-full">
            <label for="end_time" class="block text-sm font-medium mb-2 dark:text-white">End Time</label>
            <input id="end_time" required type="time" name="end_time" value="<?= $batch['end_time'] ?>" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="End Time">
        </div>
    </div>

    <div class="flex mt-5">
        <input type="checkbox" <?= $batch["is_register_open"] == 1 ? 'checked':'' ?> name="is_register_open" class="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" id="hs-default-checkbox" value="1">
