...
<form action="./studentSave.php" method="post" class=" mt-10">
    <div class=" max-w-[600px] mx-auto">
        ...
        <div class=" mt-5 max-w-[600px] ">
            ...
            <select id="gender" name="gender" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                while ($gender = mysqli_fetch_assoc($qurey)) :
                ?>
        ...
        <div class=" mt-5 max-w-[600px] ">
            ...
            <select id="nationality" name="nationality" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option selected>Choose a Nation</option>
                <?php
                $sql = "SELECT * FROM nationality";
                $qurey = mysqli_query($connect, $sql);
                while ($nations = mysqli_fetch_assoc($qurey)) :
                ?>
                    <option value="<?= $nations['id'] ?>"><?= $nations['nation'] ?></option>
                <?php endwhile ?>
            </select>
        </div>
        <div class=" max-w-[600px] mt-5">
        ...
        <div class=" max-w-[600px] mt-5">
            <label for="pocket_money" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pocket Money</label>
            <input type="number" id="name" name="pocket_money" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
        </div>
        <div class=" text-end mt-10 max-w-[600px]">
            <button type="submit" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Create Student</button>
        </div>
    </div>
</form>